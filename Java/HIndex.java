 ...
 * @author Xiao
 * LeetCode: H-Index
 * Description: Given an array of citations (each citation is a non-negative 
 *              integer) of a researcher, write a function to compute the 
 *              researcher's h-index. According to the definition of h-index on 
 *              Wikipedia: "A scientist has index h if h of his/her N papers 
 ...
 *       the h-index.
 * Idea: sort the array, the H-Index will be no less than the number at this 
 *       index.
 */
